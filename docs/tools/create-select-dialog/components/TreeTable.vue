...
import Search from '@docs/_shared/components/Search.vue'
import Tree from '@docs/_shared/components/Tree.vue'
...
const { tableData, pagination, loading } = useTable({
  listAPI: (p) => getUserList({ ...p })
})
